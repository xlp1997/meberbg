          ...
          <div class="businessTypeBox">
            <div class="businessType" v-for="(item,index) of commodityTypeList">
              ...
              <el-form-item label="平台服务费（%）">
                <el-input
                  type="text"
                  v-model="item.commodityTypeRebate"
                  placeholder="平台服务费"
                  :disabled="true"
                ></el-input>
              </el-form-item>
...
export default {
  ...
  methods: {
    ...
    pageData() {
      ...
      const _this = this;
      async("/commodityController/toEditCommodity.do", {
        ...
        .then(data => {
          ...
          if (data.code == 200) {
            ...
            this.commodityTypeList = JSON.parse(
              JSON.stringify(data.commodityTypeList)
            );
            // console.log(data);
            ...
            // 查 到付
            if (data.isCashDelivery == 1) {
              this.daofuBtn = true;
            } else {
              this.daofuBtn = false;
            }
            if (data.isSelfTaking == 1) {
              this.isSelfTaking = true;
            } else {
              this.isSelfTaking = false;
            }
          } else {
            this.$notify.error({
              title: "错误",
